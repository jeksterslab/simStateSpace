...
#> [37] pracma_2.4.4        car_3.1-3           pillar_1.10.0      
#> [40] nloptr_2.1.1        tidyr_1.3.1         MASS_7.3-60.2      
#> [43] iterators_1.0.14    abind_1.4-8         rpart_4.1.23       
#> [46] boot_1.3-30         rProject_0.0.14     mclust_6.1.1       
#> [49] foreach_1.5.2       mitml_0.4-5         nlme_3.1-164       
#> [52] lavaan_0.6-19       tidyselect_1.2.1    mvtnorm_1.3-2      
#> [55] stringi_1.8.4       dplyr_1.1.4         reshape2_1.4.4     
#> [58] purrr_1.0.2         labeling_0.4.3      splines_4.4.1      
#> [61] pcaPP_2.0-5         latex2exp_0.9.6     grid_4.4.1         
#> [64] expm_1.0-0          colorspace_2.1-1    cli_3.6.3.9001     
#> [67] magrittr_2.0.3      survival_3.6-4      pbivnorm_0.6.0     
#> [70] broom_1.0.7         withr_3.0.2         scales_1.3.0       
#> [73] backports_1.5.0     dynr_0.1.16-109     nnet_7.3-19        
#> [76] lme4_1.1-35.5       deSolve_1.40        evaluate_1.0.1     
#> [79] knitr_1.49          rbibutils_2.3       rlang_1.1.4        
#> [82] Rcpp_1.0.13-1       xtable_1.8-4        glue_1.8.0         
#> [85] fda_6.2.0           hdrcde_3.4          minqa_1.2.8        
#> [88] R6_2.5.1            plyr_1.8.9
```
...
#> Mem:            23Gi       2.6Gi        17Gi       495Mi       2.6Gi        19Gi
#> Swap:           11Gi          0B        11Gi
#> Total:          34Gi       2.6Gi        29Gi
```
