...
#>  [1] gtable_0.3.5        shape_1.4.6.1       xfun_0.45          
#>  [4] ggplot2_3.5.1       ks_1.14.2           lattice_0.22-6     
#>  [7] numDeriv_2016.8-1.1 quadprog_1.5-8      bitops_1.0-7       
#> [10] vctrs_0.6.5         tools_4.4.1         Rdpack_2.6         
...
#> [34] rainbow_3.8         RCurl_1.98-1.14     glmnet_4.1-8       
...
#> [46] rpart_4.1.23        boot_1.3-30         rProject_0.0.13    
...
#> [61] splines_4.4.1       pcaPP_2.0-4         latex2exp_0.9.6    
#> [64] grid_4.4.1          expm_0.999-9        colorspace_2.1-0   
#> [67] cli_3.6.3.9000      magrittr_2.0.3      survival_3.6-4     
#> [70] utf8_1.2.4          pbivnorm_0.6.0      broom_1.0.6        
#> [73] withr_3.0.0         scales_1.3.0        backports_1.5.0    
#> [76] dynr_0.1.16-105     nnet_7.3-19         lme4_1.1-35.4      
#> [79] deSolve_1.40        evaluate_0.24.0     knitr_1.47         
#> [82] rbibutils_2.2.16    rlang_1.1.4         Rcpp_1.0.12        
...
#> Mem:           125Gi       3.3Gi       4.7Gi       4.7Gi       117Gi       116Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       3.3Gi       4.7Gi
```
