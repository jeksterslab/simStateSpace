...
#> [10] vctrs_0.6.5         tools_4.4.0         Rdpack_2.6         
#> [13] generics_0.1.3      parallel_4.4.0      stats4_4.4.0       
#> [16] tibble_3.2.1        fansi_1.0.6         cluster_2.1.6      
#> [19] highr_0.11          pan_1.9             pkgconfig_2.0.3    
#> [22] fds_1.8             jomo_2.7-6          Matrix_1.7-0       
#> [25] KernSmooth_2.23-22  lifecycle_1.0.4     farver_2.1.2       
#> [28] compiler_4.4.0      stringr_1.5.1       mnormt_2.1.1       
...
#> [40] pillar_1.9.0        nloptr_2.0.3        tidyr_1.3.1        
...
#> [52] nlme_3.1-164        lavaan_0.6-17       tidyselect_1.2.1   
#> [55] mvtnorm_1.2-5       stringi_1.8.4       dplyr_1.1.4        
#> [58] reshape2_1.4.4      purrr_1.0.2         labeling_0.4.3     
#> [61] splines_4.4.0       pcaPP_2.0-4         latex2exp_0.9.6    
#> [64] grid_4.4.0          expm_0.999-9        colorspace_2.1-0   
#> [67] cli_3.6.3.9000      magrittr_2.0.3      survival_3.5-8     
#> [70] utf8_1.2.4          pbivnorm_0.6.0      broom_1.0.6        
#> [73] withr_3.0.0         scales_1.3.0        backports_1.5.0    
#> [76] dynr_0.1.16-105     nnet_7.3-19         lme4_1.1-35.3      
...
#> Mem:           125Gi       3.3Gi        58Gi       4.7Gi        63Gi       116Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       3.3Gi        58Gi
```
