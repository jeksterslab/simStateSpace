...
#> [10] tools_4.4.2         Rdpack_2.6.2        generics_0.1.3     
#> [13] parallel_4.4.2      tibble_3.2.1        cluster_2.1.6      
#> [16] pan_1.9             pkgconfig_2.0.3     fds_1.8            
#> [19] jomo_2.7-6          Matrix_1.7-1        KernSmooth_2.23-24 
#> [22] lifecycle_1.0.4     compiler_4.4.2      stringr_1.5.1      
#> [25] munsell_0.5.1       codetools_0.2-20    carData_3.0-5      
#> [28] rainbow_3.8         RCurl_1.98-1.16     glmnet_4.1-8       
#> [31] Formula_1.2-5       mice_3.17.0         pracma_2.4.4       
#> [34] car_3.1-3           pillar_1.10.1       nloptr_2.1.1       
#> [37] tidyr_1.3.1         MASS_7.3-61         reformulas_0.4.0   
#> [40] iterators_1.0.14    abind_1.4-8         rpart_4.1.23       
#> [43] boot_1.3-31         rProject_0.0.17     mclust_6.1.1       
#> [46] foreach_1.5.2       mitml_0.4-5         nlme_3.1-166       
#> [49] tidyselect_1.2.1    mvtnorm_1.3-3       stringi_1.8.4      
#> [52] dplyr_1.1.4         reshape2_1.4.4      purrr_1.0.2        
#> [55] splines_4.4.2       pcaPP_2.0-5         latex2exp_0.9.6    
#> [58] grid_4.4.2          colorspace_2.1-1    cli_3.6.3.9002     
#> [61] magrittr_2.0.3      survival_3.7-0      broom_1.0.7        
#> [64] scales_1.3.0        backports_1.5.0     dynr_0.1.16-109    
#> [67] nnet_7.3-19         lme4_1.1-36         deSolve_1.40       
#> [70] evaluate_1.0.3      knitr_1.49          rbibutils_2.3      
#> [73] rlang_1.1.4         Rcpp_1.0.14         hdrcde_3.4         
#> [76] xtable_1.8-4        glue_1.8.0          fda_6.2.0          
#> [79] minqa_1.2.8         R6_2.5.1            plyr_1.8.9
```
...
#> Mem:           125Gi       9.4Gi        87Gi       5.2Gi        35Gi       116Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       9.4Gi        87Gi
```
