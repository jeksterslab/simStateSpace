...
#> [1] simStateSpace_1.2.3
#> 
#> loaded via a namespace (and not attached):
#>  [1] tidyselect_1.2.1    hdrcde_3.4          dplyr_1.1.4        
#>  [4] farver_2.1.2        bitops_1.0-9        latex2exp_0.9.6    
#>  [7] RCurl_1.98-1.16     pracma_2.4.4        rpart_4.1.23       
#> [10] lifecycle_1.0.4     cluster_2.1.6       survival_3.6-4     
#> [13] magrittr_2.0.3      compiler_4.4.1      rlang_1.1.4        
#> [16] tools_4.4.1         utf8_1.2.4          rProject_0.0.14    
#> [19] knitr_1.49          labeling_0.4.3      mclust_6.1.1       
#> [22] mnormt_2.1.1        plyr_1.8.9          dynr_0.1.16-109    
#> [25] rainbow_3.8         abind_1.4-8         KernSmooth_2.23-24 
#> [28] fda_6.2.0           expm_1.0-0          withr_3.0.2        
#> [31] purrr_1.0.2         numDeriv_2016.8-1.1 nnet_7.3-19        
#> [34] grid_4.4.1          pcaPP_2.0-5         stats4_4.4.1       
#> [37] fansi_1.0.6         lavaan_0.6-19       jomo_2.7-6         
#> [40] xtable_1.8-4        colorspace_2.1-1    mice_3.16.0        
#> [43] ggplot2_3.5.1       scales_1.3.0        iterators_1.0.14   
#> [46] MASS_7.3-60.2       cli_3.6.3.9001      mvtnorm_1.3-2      
#> [49] generics_0.1.3      reshape2_1.4.4      fds_1.8            
#> [52] minqa_1.2.8         stringr_1.5.1       splines_4.4.1      
#> [55] parallel_4.4.1      vctrs_0.6.5         boot_1.3-30        
#> [58] glmnet_4.1-8        Matrix_1.7-0        carData_3.0-5      
#> [61] car_3.1-3           mitml_0.4-5         Formula_1.2-5      
#> [64] foreach_1.5.2       tidyr_1.3.1         glue_1.8.0         
#> [67] nloptr_2.1.1        pan_1.9             codetools_0.2-20   
#> [70] stringi_1.8.4       shape_1.4.6.1       gtable_0.3.6       
#> [73] quadprog_1.5-8      lme4_1.1-35.5       munsell_0.5.1      
#> [76] tibble_3.2.1        pillar_1.9.0        deSolve_1.40       
#> [79] R6_2.5.1            Rdpack_2.6.2        ks_1.14.3          
#> [82] evaluate_1.0.1      pbivnorm_0.6.0      lattice_0.22-6     
#> [85] rbibutils_2.3       backports_1.5.0     broom_1.0.7        
#> [88] Rcpp_1.0.13-1       nlme_3.1-164        xfun_0.49          
#> [91] pkgconfig_2.0.3
```
...
#>                   Package             Version      
#> simStateSpace     "simStateSpace"     "1.2.3"      
#> abind             "abind"             "1.4-8"      
#> arm               "arm"               "1.14-4"     
...
#> Rcpp              "Rcpp"              "1.0.13-1"   
#> RcppArmadillo     "RcppArmadillo"     "14.2.0-1"   
...
#> Mem:           125Gi       3.2Gi        17Gi       5.1Gi       105Gi       116Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       3.2Gi        17Gi
```
