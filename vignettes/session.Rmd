...
#> [1] simStateSpace_1.2.12.9000
#> 
#> loaded via a namespace (and not attached):
#>  [1] tidyselect_1.2.1    hdrcde_3.4          dplyr_1.1.4        
#>  [4] farver_2.1.2        S7_0.2.0            bitops_1.0-9       
#>  [7] latex2exp_0.9.6     RCurl_1.98-1.17     pracma_2.4.4       
#> [10] rpart_4.1.24        lifecycle_1.0.4     cluster_2.1.8.1    
#> [13] survival_3.8-3      magrittr_2.0.4      compiler_4.5.1     
#> [16] rlang_1.1.6         tools_4.5.1         rProject_0.0.21    
...
#> [31] withr_3.0.2         purrr_1.1.0         numDeriv_2016.8-1.1
#> [34] nnet_7.3-20         grid_4.5.1          pcaPP_2.0-5        
#> [37] stats4_4.5.1        lavaan_0.6-20       jomo_2.7-6         
#> [40] xtable_1.8-4        colorspace_2.1-2    mice_3.18.0        
#> [43] ggplot2_4.0.0       scales_1.4.0        iterators_1.0.14   
#> [46] MASS_7.3-65         cli_3.6.5.9000      mvtnorm_1.3-3      
#> [49] reformulas_0.4.1    generics_0.1.4      reshape2_1.4.4     
#> [52] fds_1.8             minqa_1.2.8         stringr_1.5.2      
#> [55] splines_4.5.1       parallel_4.5.1      vctrs_0.6.5        
#> [58] boot_1.3-31         glmnet_4.1-10       Matrix_1.7-3       
...
#> [73] gtable_0.3.6        quadprog_1.5-8      lme4_1.1-37        
...
#> [85] rbibutils_2.3       backports_1.5.0     broom_1.0.10       
#> [88] Rcpp_1.1.0          nlme_3.1-168        xfun_0.53          
#> [91] pkgconfig_2.0.3
```
...
#> Mem:           251Gi        11Gi       178Gi       5.6Gi        69Gi       240Gi
#> Swap:             0B          0B          0B
#> Total:         251Gi        11Gi       178Gi
```
