...
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>   eta0 ~~                                             
#>     eta1    (s0_0)    0.613    0.042   14.762    0.000
#> 
#> Intercepts:
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>     eta0    (m0_0)    0.617    0.047   13.086    0.000
#>     eta1    (m0_1)    0.997    0.026   38.728    0.000
#> 
#> Variances:
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>     eta0    (s0_0)    1.859    0.100   18.600    0.000
#>     eta1    (s0_1)    0.602    0.030   20.275    0.000
