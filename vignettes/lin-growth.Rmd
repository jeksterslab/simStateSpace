---
title: "Linear Growth Curve Model"
...
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Linear Growth Curve Model}
...
$\eta_{0_{i, t}}$,
$\eta_{1_{i, t}}$ is forms a vector of latent random variables
at time $t$ and individual $i$,
and $\boldsymbol{\varepsilon}_{i, t}$
