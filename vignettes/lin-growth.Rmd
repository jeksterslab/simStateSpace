...
#> Original fitted parameters:  -0.5162666 0.6113811 0.8541472 0.3537251 0.2636226 
#> -1.065779 
#> 
#> Transformed fitted parameters:  0.5967443 0.6113811 0.8541472 1.424364 
#> 0.3754945 0.4434484 
#> 
#> Doing end processing
#> Successful trial
#> Total Time: 0.8716574 
#> Backend Time: 0.4725487
```
...
#> theta      0.59674    0.04873  12.247  0.50124  0.69224  < 2e-16 ***
#> mu0_0      0.61138    0.13350   4.580  0.34972  0.87304 2.95e-06 ***
#> mu0_1      0.85415    0.07093  12.042  0.71512  0.99317  < 2e-16 ***
#> sigma0_00  1.42436    0.25381   5.612  0.92690  1.92183 2.00e-08 ***
#> sigma0_01  0.37549    0.09859   3.809  0.18227  0.56872 7.86e-05 ***
#> sigma0_11  0.44345    0.07132   6.218  0.30366  0.58323  < 2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> -2 log-likelihood value at convergence = 1636.79
#> AIC = 1648.79
#> BIC = 1674.08
```
...
sigma0_hat
#>           [,1]      [,2]
#> [1,] 1.4243636 0.3754945
#> [2,] 0.3754945 0.4434484
theta_hat
#>     theta 
#> 0.5967443
```
...
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>   eta0 ~~                                             
#>     eta1    (s0_0)    0.376    0.099    3.809    0.000
#> 
#> Intercepts:
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>     eta0    (m0_0)    0.611    0.134    4.580    0.000
#>     eta1    (m0_1)    0.854    0.071   12.042    0.000
#> 
#> Variances:
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>     eta0    (s0_0)    1.424    0.254    5.613    0.000
#>     eta1    (s0_1)    0.443    0.071    6.218    0.000
#>    .y1_0    (thet)    0.597    0.049   12.247    0.000
#>    .y1_1    (thet)    0.597    0.049   12.247    0.000
#>    .y1_2    (thet)    0.597    0.049   12.247    0.000
#>    .y1_3    (thet)    0.597    0.049   12.247    0.000
#>    .y1_4    (thet)    0.597    0.049   12.247    0.000
```
