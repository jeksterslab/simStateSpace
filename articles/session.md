...
#> [1] simStateSpace_1.2.13
#> 
#> loaded via a namespace (and not attached):
#>  [1] gtable_0.3.6        shape_1.4.6.1       xfun_0.55          
#>  [4] ggplot2_4.0.1       ks_1.15.1           lattice_0.22-7     
#>  [7] numDeriv_2016.8-1.1 bitops_1.0-9        vctrs_0.6.5        
#> [10] tools_4.5.2         Rdpack_2.6.4        generics_0.1.4     
#> [13] tibble_3.3.0        cluster_2.1.8.1     pan_1.9            
#> [16] pkgconfig_2.0.3     fds_1.8             jomo_2.7-6         
#> [19] Matrix_1.7-4        KernSmooth_2.23-26  RColorBrewer_1.1-3 
#> [22] S7_0.2.1            lifecycle_1.0.4     compiler_4.5.2     
#> [25] farver_2.1.2        stringr_1.6.0       codetools_0.2-20   
#> [28] carData_3.0-5       rainbow_3.8         RCurl_1.98-1.17    
#> [31] glmnet_4.1-10       Formula_1.2-5       pracma_2.4.6       
#> [34] mice_3.19.0         car_3.1-3           pillar_1.11.1      
#> [37] nloptr_2.2.1        tidyr_1.3.2         MASS_7.3-65        
#> [40] reformulas_0.4.3    iterators_1.0.14    abind_1.4-8        
#> [43] rpart_4.1.24        boot_1.3-32         rProject_0.0.23    
#> [46] mclust_6.1.2        foreach_1.5.2       mitml_0.4-5        
#> [49] nlme_3.1-168        tidyselect_1.2.1    mvtnorm_1.3-3      
#> [52] stringi_1.8.7       dplyr_1.1.4         reshape2_1.4.5     
#> [55] purrr_1.2.0         labeling_0.4.3      splines_4.5.2      
#> [58] pcaPP_2.0-5         latex2exp_0.9.6     grid_4.5.2         
#> [61] colorspace_2.1-2    expm_1.0-0          cli_3.6.5.9000     
#> [64] magrittr_2.0.4      survival_3.8-3      broom_1.0.11       
#> [67] withr_3.0.2         scales_1.4.0        backports_1.5.0    
#> [70] dynr_0.1.16-114     otel_0.2.0          nnet_7.3-20        
#> [73] lme4_1.1-38         deSolve_1.40        evaluate_1.0.5     
#> [76] knitr_1.51          rbibutils_2.4       rlang_1.1.6        
#> [79] Rcpp_1.1.0          hdrcde_3.4          xtable_1.8-4       
#> [82] glue_1.8.0          fda_6.3.0           minqa_1.2.8        
#> [85] R6_2.6.1            plyr_1.8.9
```
...
#>                   Package             Version      
#> simStateSpace     "simStateSpace"     "1.2.13"     
#> abind             "abind"             "1.4-8"      
#> Amelia            "Amelia"            "1.8.3"      
#> arm               "arm"               "1.14-4"     
#> arrow             "arrow"             "22.0.0.1"   
#> ash               "ash"               "1.0-15"     
...
#> fds               "fds"               "1.8"        
#> fitDTVARMxID      "fitDTVARMxID"      "0.0.0.9003" 
#> FNN               "FNN"               "1.1.4.1"    
...
## Memory
    ...
    #> Mem:           125Gi        10Gi        42Gi       5.2Gi        78Gi       115Gi
    #> Swap:             0B          0B          0B
    #> Total:         125Gi        10Gi        42Gi
