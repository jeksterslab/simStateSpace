...
#> [1] simStateSpace_1.2.16
#> 
#> loaded via a namespace (and not attached):
#>  [1] tidyselect_1.2.1    hdrcde_3.5.0        dplyr_1.2.0        
#>  [4] farver_2.1.2        S7_0.2.1            bitops_1.0-9       
#>  [7] latex2exp_0.9.8     RCurl_1.98-1.17     pracma_2.4.6       
#> [10] rpart_4.1.24        lifecycle_1.0.5     cluster_2.1.8.2    
#> [13] survival_3.8-6      magrittr_2.0.4      compiler_4.5.3     
#> [16] rlang_1.1.7         tools_4.5.3         rProject_0.0.25    
...
#> [34] nnet_7.3-20         grid_4.5.3          pcaPP_2.0-5        
#> [37] stats4_4.5.3        lavaan_0.6-21       jomo_2.7-6         
#> [40] xtable_1.8-8        colorspace_2.1-2    mice_3.19.0        
#> [43] ggplot2_4.0.2       scales_1.4.0        iterators_1.0.14   
#> [46] MASS_7.3-65         cli_3.6.5.9000      mvtnorm_1.3-5      
#> [49] reformulas_0.4.4    generics_0.1.4      otel_0.2.0         
#> [52] reshape2_1.4.5      fds_1.8             minqa_1.2.8        
#> [55] stringr_1.6.0       splines_4.5.3       parallel_4.5.3     
#> [58] vctrs_0.7.1         boot_1.3-32         glmnet_4.1-10      
#> [61] Matrix_1.7-4        carData_3.0-6       car_3.1-5          
...
#> [79] deSolve_1.41        R6_2.6.1            Rdpack_2.6.6       
#> [82] ks_1.15.1           evaluate_1.0.5      pbivnorm_0.6.0     
#> [85] lattice_0.22-9      rbibutils_2.4.1     backports_1.5.0    
#> [88] broom_1.0.12        Rcpp_1.1.1          nlme_3.1-168       
#> [91] xfun_0.57           pkgconfig_2.0.3
```
...
## Memory
    ...
    #> Mem:            23Gi       7.1Gi       6.7Gi       350Mi        10Gi        16Gi
    #> Swap:           11Gi       4.0Mi        11Gi
    #> Total:          34Gi       7.1Gi        18Gi
