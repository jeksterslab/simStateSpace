...
This function simulates random intercept vectors in a continuous-time
...
- vcov_iota_l:
  ...
  Numeric matrix. Cholesky factorization (`t(chol(vcov_iota))`) of the
  sampling variance-covariance matrix of \\\boldsymbol{\iota}\\.
