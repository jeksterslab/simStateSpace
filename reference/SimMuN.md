...
This function simulates random set point vectors from the multivariate
normal distribution.
...
- vcov_mu_l:
  ...
  Numeric matrix. Cholesky factorization (`t(chol(vcov_mu))`) of the
  sampling variance-covariance matrix of \\\boldsymbol{\mu}\\.
